...
//key used to persist the currently logged-in parent and child id as a string
...
//DataStore session manager provides session persistence (store current parent and child id)
